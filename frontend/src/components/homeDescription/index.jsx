            ...
            <div className='home-why'>
                <div className='container-item'>
                    <div className='inner-item left'>
                        ...
                        <img src="https://www.wallpaperflare.com/static/452/109/152/furious-7-fast-and-the-furious-hd-4k-wallpaper.jpg" />
                    </div>
                </div>
                <div className='container-item'>
                    <div className='inner-item right'>
                        ...
                        <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sit amet nibh ut odio vulputate porttitor nec ut eros. Ut fermentum</span>
                        <img src="https://images.hdqwalls.com/download/fast-and-furious-9-the-fast-saga-2020-3r-1920x1080.jpg" />
                    </div>
                </div>
                <div className='container-item'>
                    <div className='inner-item left' style={{marginBottom:'40px'}}>
                        ...
                        <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sit amet nibh ut odio vulputate porttitor nec ut eros. Ut fermentum</span>
                        <img src="https://cdn.wallpapersafari.com/58/99/M3agOj.jpg" />
                    </div>
                </div>
            </div>
            <Footer />
